...
from os_cloud_config.keystone import initialize_for_swift
...
def main():
    ...
    if options.host is None or options.admin_token is None:
        print("All options are required.")
        return 1
    initialize_for_swift(options.host, options.admin_token)
