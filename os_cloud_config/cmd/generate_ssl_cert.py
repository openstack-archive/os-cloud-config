...
def parse_args():
    ...
    This script generates and signs a certificate using the CA in the heat
    environment. If no CA is in the heat environment then a new CA will be
    generated. The resulting certificate and CA (if one is made) are added to
