...
class NodesTest(base.TestCase):
    ...
    def test_register_all_nodes_nova_bm(self):
        ...
        nova_bm_call = mock.call(
            ["nova", "baremetal-node-create", "--pm_address=foo.bar",
             ...
             "2048", "30", "aaa"])
        subprocess.check_output.has_calls([nova_bm_call, nova_bm_call])
    ...
    def test_register_all_nodes_ironic(self):
        ...
        subprocess.check_output.has_calls([pxe_node_create, impi_node_create])
        ...
        subprocess.check_call.assert_has_calls(
            [pxe_node_update_call, port_update_call, impi_node_update_call,
             port_update_call])
