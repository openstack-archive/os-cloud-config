...
class NodesTest(base.TestCase):
    ...
    def test_register_all_nodes_nova_bm(self):
        ...
        nodes._check_output = mock.MagicMock()
        ...
        nova_bm_call = mock.call(
            ["nova", "baremetal-node-create", "--pm_address=foo.bar",
             ...
             "2048", "30", "aaa"])
        nodes._check_output.has_calls([nova_bm_call, nova_bm_call])

    @mock.patch('subprocess.check_call')
    def test_register_all_nodes_ironic(self, check_call):
        node_list = [self._get_node(), self._get_node()]
        ...
        nodes._check_output.has_calls([pxe_node_create, impi_node_create])
