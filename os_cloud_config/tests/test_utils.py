...
class UtilsTest(base.TestCase):
    ...
    def assertRaisesWithContent(self, excp, call, message):
        exception = self.assertRaises(excp, call)
    ...
    def test_ensure_environment_missing_all(self):
        ...
        self.assertRaisesWithContent(utils.MissingEnvironment,
                                     utils._ensure_environment, message)

    @mock.patch.object(os, 'environ', {'OS_PASSWORD': 'a', 'OS_AUTH_URL': 'a',
                       'OS_TENANT_NAME': 'a'})
